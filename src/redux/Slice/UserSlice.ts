...
const userSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(checkIfLoggedUserReducer.pending,(state)=>{
            state.loading = true
        })
        builder.addCase(checkIfLoggedUserReducer.fulfilled,(state,action)=>{
                state._id = action.payload._id;
                state.name = action.payload.name;
                state.email = action.payload.email;
                state.isAdmin = action.payload.isAdmin
        ...
        builder.addCase(checkIfLoggedUserReducer.rejected,(state)=>{
            state.loading = false
            logout()
        })
        }
